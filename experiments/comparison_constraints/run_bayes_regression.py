...
from multitaskpinn.training import train_bayes
...
for run in torch.arange(n_runs):
    ...
    train_bayes(model, X, y, optimizer, sparsity_scheduler, exp_ID=f'bayes_run_{run}', split=0.8, write_iterations=50, max_iterations=15000, delta=1e-3, patience=200) 