...
for run_idx in np.arange(n_runs):
    ...
    train(model, X, y, optimizer, sparsity_scheduler, log_dir=f'data_high_noise/baseline_run_{run_idx}/', write_iterations=25, max_iterations=5000, delta=0.00, patience=100) # Running
