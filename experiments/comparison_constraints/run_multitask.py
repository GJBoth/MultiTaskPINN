...
for run in torch.arange(n_runs):
    ...
    train_multitask(model, X, y, optimizer, sparsity_scheduler, exp_ID=f'multitask_run_{run}', split=0.8, write_iterations=50, max_iterations=15000, delta=1e-3, patience=200) 